...
const rawLeads: LeadProfile[] = [
  ...
  {
    slug: "brunner-baustoffe-bad-mergentheim-b7k4m2",
    family: "construction",
    status: "research",
    businessName: "Sebastian Brunner Baustoffe & Transporte",
    businessType: "Baustoffe, Transporte & Erdarbeiten",
    city: "Bad Mergentheim",
    tagline: "Ihre Baustelle ist unser Job.",
    shortDescription:
      "Dieser unverbindliche Entwurf zeigt Sebastian Brunner Baustoffe & Transporte aus Bad Mergentheim-Wachbach — zuverlässige Baustofflieferung, Transporte und Erdarbeiten direkt auf Ihre Baustelle.",
    primaryCta: "call",
    highlights: [
      "Baustoffe & Transporte aus einer Hand",
      "Erdarbeiten & Aushub",
      "Ihre Baustelle ist unser Job",
      "Standort Wachbach & Bad Mergentheim",
      "Termingerechte Lieferung",
      "Regionaler Fachbetrieb im Main-Tauber-Kreis",
    ],
    services: [
      { title: "Baustofflieferung", description: "Zuverlässige Lieferung von Baustoffen termingerecht direkt auf Ihre Baustelle." },
      { title: "Transporte", description: "Transporte von Material und Schüttgut — flexibel und pünktlich." },
      { title: "Erdarbeiten", description: "Erdarbeiten und Aushub für Neubau, Umbau und Außenanlagen." },
      { title: "Schüttgüter", description: "Anlieferung gängiger Schüttgüter für Bau und Garten." },
      { title: "Baustellen-Service", description: "Praktische Unterstützung rund um Material und Logistik auf der Baustelle." },
      { title: "Beratung", description: "Persönliche Abstimmung von Menge, Termin und Anlieferung." },
    ],
    process: [
      { title: "Anfrage", description: "Material, Menge und Liefertermin unverbindlich besprechen." },
      { title: "Planung", description: "Anlieferung und Transport passend zur Baustelle abstimmen." },
      { title: "Lieferung", description: "Pünktliche Anlieferung direkt an den Einsatzort." },
      { title: "Erdarbeiten", description: "Aushub und Erdarbeiten nach Absprache ausführen." },
    ],
    certifications: [
      { title: "Baustoffe & Transporte", description: "Lieferung und Transport von Baumaterial aus einer Hand." },
      { title: "Erdarbeiten", description: "Aushub und Erdarbeiten für Bauvorhaben in der Region." },
      { title: "Region Main-Tauber", description: "Betrieb in Bad Mergentheim-Wachbach, kurze Wege in der Region." },
    ],
    openingHours: ["Mo–Fr 07:00–17:00", "Sa nach Vereinbarung"],
    contact: {
      phone: "+49 160 96432007",
      email: "info@brunner-baustoffe.de",
      address: "Schafhof 1, 97980 Bad Mergentheim-Wachbach",
      mapsUrl:
        "https://www.google.com/maps/place/Sebastian+Brunner/@49.4808008,9.77212,17z",
      website: "https://www.brunner-baustoffe.de/",
      instagramUrl: "https://www.instagram.com/",
    },
    media: mediaFor("brunner-baustoffe-bad-mergentheim-b7k4m2"),
    sources: [
      "https://www.brunner-baustoffe.de/",
      "https://www.google.com/maps/place/Sebastian+Brunner/",
    ],
    notes:
      "Sebastian Brunner Baustoffe & Transporte. Büro Mozartstraße 3, 97980 Bad Mergentheim; Bauhof Schafhof 1, 97980 Bad Mergentheim-Wachbach. Telefon 0160 96432007 (Bauhof 0151 27178715), info@brunner-baustoffe.de. Leistungen laut Website: Baustofflieferung, Transporte, Erdarbeiten. Slogan 'Ihre Baustelle ist unser Job'. Mo–Fr 07:00–17:00, Sa nach Vereinbarung. Wix-One-Pager — nur ein freigegebenes Baustellenfoto verfügbar; Marken-Logo (Text) im Header nachgebaut. Ersetzt den früheren Hoyer-Entwurf.",
  },
  {
  ...
  {
    slug: "carcare-mgh-bad-mergentheim-c4r7k9",
    family: "corporate",
    status: "research",
    businessName: "CarCare Kfz-Meisterbetrieb",
    businessType: "Kfz-Meisterbetrieb & Fahrzeugaufbereitung",
    city: "Bad Mergentheim",
    tagline: "Ihr Auto in besten Händen.",
    shortDescription:
      "Unverbindlicher Demo-Auftritt für CarCare in Bad Mergentheim — Kfz-Meisterbetrieb für Inspektion, Wartung, Diagnose, Reifen- und Klimaservice sowie professionelle Fahrzeugaufbereitung. Wir kriegen das hin.",
    primaryCta: "call",
    highlights: [
      "Kfz-Meisterbetrieb",
      "Diagnose & Fehlersuche",
      "Klima- & Autoglasservice",
      "Reifen- & Batterieservice",
      "Fahrzeugaufbereitung (Koch Chemie)",
      "Abschleppdienst",
    ],
    services: [
      { title: "Inspektion & Wartung", description: "Mechanik-Check, Inspektion und Wartung für einen sicheren Betrieb." },
      { title: "Öl- & Bremsenservice", description: "Öl-, Filter- und Bremsencheck mit klarer Abstimmung vor der Reparatur." },
      { title: "Diagnose & Fehlersuche", description: "Elektronik- und Fehlerdiagnose, damit die Reparatur gezielt startet." },
      { title: "Reifen- & Batterieservice", description: "Reifenwechsel, Einlagerung und Batterieprüfung aus einer Hand." },
      { title: "Klima- & Autoglasservice", description: "Klimaanlagen-Service und Autoglas – Reparatur und Austausch." },
      { title: "Fahrzeugaufbereitung", description: "Professionelle Aufbereitung mit Koch-Chemie-Produkten, innen und außen." },
    ],
    openingHours: ["Mo–Fr 09:00–18:00", "Sa/So geschlossen"],
    contact: {
      phone: "+49 171 1283947",
      email: "carcare.mgh@web.de",
      address: "Buchener Straße 28, 97980 Bad Mergentheim",
      mapsUrl: maps("CarCare Buchener Straße 28 Bad Mergentheim"),
      website: "https://carcare-mgh.de/",
      instagramUrl: "https://www.instagram.com/carcare.mgh/",
    },
    media: mediaFor("carcare-mgh-bad-mergentheim-c4r7k9"),
    sources: [
      "https://carcare-mgh.de/",
      "https://www.instagram.com/carcare.mgh/",
    ],
    notes:
      "CarCare Kfz-Meisterbetrieb, Buchener Straße 28, 97980 Bad Mergentheim. Telefon 0171 1283947, carcare.mgh@web.de, Instagram @carcare.mgh. Mo–Fr 09:00–18:00. Slogans 'Ihr Auto in besten Händen' und 'Wir kriegen das hin'. Leistungen: Inspektion/Wartung, Öl- & Bremsencheck, Diagnose, Autoglas, Reifen-, Batterie-, Klimaservice, Fahrzeugaufbereitung (Koch-Chemie-Partner), Abschleppdienst. Wix-Seite — nur Marken-Logo als Bild verfügbar (schwarz/rot), keine freigegebenen Werkstattfotos. Demo daher grafisch/effektgetrieben. 'Since 2023'.",
  },
  {
    slug: "tcp-tuning-bad-mergentheim-t8p3v6",
    family: "corporate",
    status: "research",
    businessName: "TCP – Top Car Performance",
    businessType: "Kfz-Meisterbetrieb & Chiptuning",
    city: "Bad Mergentheim",
    tagline: "Sie suchen, wir finden.",
    shortDescription:
      "Unverbindlicher Demo-Auftritt für TCP – Top Car Performance in Bad Mergentheim: Kfz-Meisterbetrieb und Profi-Tuning mit Chiptuning, Leistungsoptimierung und eigenem Prüfstand — für PKW, LKW, Motorrad und mehr.",
    primaryCta: "call",
    highlights: [
      "Kfz-Meisterbetrieb & Tuning",
      "Chiptuning PKW · LKW · Motorrad",
    ...
    services: [
      { title: "Chiptuning", description: "Chiptuning für PKW, LKW, Motorrad und Landmaschinen." },
      { title: "Leistungsoptimierung", description: "Individuelle Leistungssteigerung mit Messung auf dem Prüfstand." },
      { title: "Eco Tuning", description: "Optimierung für weniger Verbrauch bei gleicher Fahrbarkeit." },
      { title: "V-Max Aufhebung", description: "Aufhebung der Höchstgeschwindigkeitsbegrenzung nach Wunsch." },
      { title: "Steuergerät-Programmierung", description: "Auslesen, Optimieren und Aufspielen der Motorsteuerung." },
      { title: "Prüfstand & Reparatur", description: "Leistungsmessung auf dem Dyno und Reparaturen aller Marken." },
    ],
    contact: {
      phone: "+49 7931 1214511",
      email: "info@tcp-tuning.de",
      address: "Herrenwiesenstraße 57, 97980 Bad Mergentheim",
      mapsUrl: maps("TCP Top Car Performance Herrenwiesenstraße 57 Bad Mergentheim"),
      website: "https://www.tcp-tuning.de/",
      instagramUrl: "https://www.instagram.com/",
    },
    media: mediaFor("tcp-tuning-bad-mergentheim-t8p3v6"),
    sources: [
      "https://www.tcp-tuning.de/",
      "https://www.tcp-tuning.de/chiptuning/",
    ],
    notes:
      "TCP – Top Car Performance, Kfz-Meisterbetrieb & Tuning, Inhaber Arsim Murtezi. Herrenwiesenstraße 57, 97980 Bad Mergentheim. Telefon 07931 1214511, info@tcp-tuning.de. Slogan 'Sie suchen, wir finden'. Leistungen: Chiptuning (PKW/LKW/Motorrad/Landmaschinen), V-Max Aufhebung, Eco Tuning, Leistungsoptimierung, Steuergerät-Programmierung, Prüfstand/Dyno, Reparaturen aller Marken, Verbrauchsoptimierung. Auch Boote/Jetski/Traktoren. WordPress-Seite mit Hero-Video (Slider_weba2.mp4) — als Hintergrundvideo im Demo verwendet (komprimiert). Echte Werkstatt-/Prüfstand-/Fahrzeugfotos übernommen.",
  },
  {
    slug: "kfz-niko-deissler-bad-mergentheim-n5d8k2",
    family: "corporate",
    status: "research",
    businessName: "KFZ-Meisterbetrieb Niko Deißler",
    businessType: "Kfz-Meisterbetrieb & Werkstatt",
    city: "Bad Mergentheim",
    tagline: "Schnell, professionell und fair.",
    shortDescription:
      "Unverbindlicher Demo-Auftritt für den KFZ-Meisterbetrieb Niko Deißler in Bad Mergentheim-Wachbach: Fahrzeugservice, Motor- und Elektroservice, Reifen, Bremsen und Abschleppdienst — kompetent und zu fairen Preisen.",
    primaryCta: "call",
    highlights: [
      "Kfz-Meisterbetrieb",
      "Elektro- & Hybridfahrzeuge",
      "TÜV-Durchsicht & Inspektion",
      "Achsvermessung",
      "Abschlepp- & Pannenhilfe",
      "Ersatzteile in Erstausrüsterqualität",
    ],
    services: [
      { title: "Fahrzeugservice & Inspektion", description: "Inspektion, Urlaubs-, Winter- und Frühjahrscheck sowie TÜV-Durchsicht." },
      { title: "Motorservice", description: "Öl- und Filterwechsel, Motordiagnose, Diesel- und Kraftstoffsystemreinigung." },
      { title: "Elektro & Hybrid", description: "Elektroservice, Elektronikdiagnose und Wartung von Sicherheitssystemen." },
      { title: "Klima & Achsvermessung", description: "Wartung und Instandsetzung der Klimaanlage sowie Achsvermessung." },
      { title: "Reifen & Räder", description: "Räderwechsel mit Auswuchten, Waschen, Einlagern und RDKS-Wartung." },
      { title: "Bremsen & Batterie", description: "Bremsbeläge, Bremsscheiben, Bremsflüssigkeits- und Batterieservice." },
    ],
    openingHours: ["Mo–Fr 07:30–17:30", "Sa 09:00–12:00"],
    contact: {
      phone: "+49 7931 478428",
      email: "info@kfznikodeissler.de",
      address: "In den Torgärten 7, 97980 Bad Mergentheim-Wachbach",
      mapsUrl: maps("KFZ Niko Deißler In den Torgärten 7 Bad Mergentheim Wachbach"),
      website: "https://www.kfznikodeissler.de/",
    },
    media: mediaFor("kfz-niko-deissler-bad-mergentheim-n5d8k2"),
    sources: [
      "https://www.kfznikodeissler.de/",
      "https://www.kfznikodeissler.de/leistungen",
    ],
    notes:
      "KFZ-Meisterbetrieb Niko Deißler GmbH, In den Torgärten 7, 97980 Bad Mergentheim-Wachbach. Telefon 07931 478428, Fax 07931 478429, info@kfznikodeissler.de. Mo–Fr 07:30–17:30, Sa 09:00–12:00. Leistungen laut /leistungen: Fahrzeugservice (Inspektion, Urlaubs-/Winter-/Frühjahrscheck, TÜV-Durchsicht), Mechanik (Erstausrüsterqualität), Motorservice (Öl/Filter, Motordiagnose, Diesel-/Kraftstoff-/Ansaugsystemreinigung), Elektro & Hybrid, Klimaservice, Achsvermessung, Abschlepp-/Pannenhilfe, Räderwechsel/Auswuchten/Einlagern, RDKS, Reifen & Felgen, Bremsen, Bremsflüssigkeit, Batterieservice, Elektronikdiagnose, Start-Stopp, Sicherheitssysteme, Getriebeölspülung. Echte Fotos übernommen: Werkstattgebäude und Teamfoto.",
  },
];
